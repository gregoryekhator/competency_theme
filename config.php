...
$THEME->name = 'competency';
$THEME->parents = ['boost'];
$THEME->sheets = [];
$THEME->editor_sheets = [];
$THEME->usefallback = true;
$THEME->scss = function($theme) {
    return theme_competency_get_main_scss_content($theme);
};
...
$THEME->prescsscallback = 'theme_competency_get_pre_scss';
$THEME->extrascsscallback = 'theme_competency_get_extra_scss';
$THEME->rendererfactory = 'theme_overridden_renderer_factory';
$THEME->precompiledcsscallback = 'theme_competency_get_precompiled_css';
