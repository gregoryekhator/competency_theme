...
$logo = theme_competency_get_logo_url();
...
$this->page->requires->js('/theme/competency/javascript/blockslider.js');

echo $OUTPUT->render_from_template('theme_competency/frontpage', $templatecontext);
