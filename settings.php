...
/* THEME_competency BUILDING NOTES
 * =============================
...
if ($ADMIN->fulltree) {
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingcompetency', get_string('configtitle', 'theme_competency'));
    ...
    require('settings/categories_settings.php');
