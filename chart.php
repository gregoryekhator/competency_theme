...
$sales = new \core\chart_series('Sales', [1000, 1170, 660]);
$expenses = new \core\chart_series('Expenses', [400, 460, 1120]);
...
echo '<tbody>';
echo '<tr><td width="20%">Best<br/>Worst<br/>Learning Path</td><td width="40%">'.$OUTPUT->render($chart).'</td><td width="40%">'.$OUTPUT->render($chart2).'</td></tr>';
echo '</tbody>';
echo '</table>';
echo $OUTPUT->footer();
