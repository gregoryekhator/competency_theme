...
/**
 * Theme competency - Language pack
 *
...
$string['pluginname'] = 'Competency Theme';
$string['choosereadme'] = 'Theme competency is an enhanced child theme of Boost provided by Moodle Debonair Training Ltd';
$string['configtitle'] = 'competency';
$string['privacy:metadata'] = 'The competency theme does not store any personal data about any user.';
...
$string['sections-competency'] = 'competency Default Style';
...
$string['promoted_courses'] = 'Feature Courses';
$string['promotedtitledefault'] = 'Feature Courses';
...
$string['pcourses'] = 'Feature Courses';
$string['pcoursesdesc'] = 'Please give the promoted courses id should separated by comma.';
$string['promotedcoursesheading'] = 'Courses you may be interested in';
...
$string['headerlogo'] = 'Header Image';
$string['headerlogo_desc'] = 'This is for uploading the header image desired on the home page';
...
$string['generalcontentinfodesc'] = 'The options below help you customize the way content is displayed and turn on additional features for competency.';
...
$string['sectionlayout_desc'] = 'Choose from the following topic/weekly section styles.  <a href="https://goo.gl/fMXzSo" target="_new">Instructions for competency</a>';
...
$string['blockwidthcompetency'] = 'Block Column Width';
$string['blockwidthcompetency_desc'] = 'Adjust the width of the block column.';
...
$string['coursetilestyle_desc'] = 'When viewing course categories you can choose from the following styles to display courses. <a href="https://goo.gl/fMXzSo" target="_new">Instructions for competency </a>';
...
$string['setting_navdrawersettings_desc'] = 'Enable the Boost nav drawer feature.  competency does not require the nav drawer for navigation.  We have replaced it with a Jump-to-section dropdown. You may re-enable the nav drawer below.';
$string['shownavdrawer'] = 'Show Navdrawer';
$string['shownavdrawer_desc'] = 'competency has eliminated the need for the nav drawer by utilizing a drop-down menu for in-course navigation.  If you must use the nav drawer you can check this box to re-enable it.';
...
* competency > Custom Image Settings > Default Login Image can be used to change the background image for the login page. <br>
* competency > Content Areas > Homepage Alert can be used to provide a notice on the top of the page. </b>';
...
$string['naviconbutton1textdefault'] = 'Metrics';
$string['naviconbutton2textdefault'] = 'Time';
$string['naviconbutton3textdefault'] = 'Certification';
$string['naviconbutton4textdefault'] = 'Classes';
...
$string['categoriesheading'] = 'Categories Tiles';
...
$string['categoryinfodesc'] = 'Enter the settings for your Category spot.  You must include a title in order for the Category Spot to appear.  The title will activate the individual Category Spots.';
...
$string['category1'] = 'Category Spot One';
$string['category2'] = 'Category Spot Two';
$string['category3'] = 'Category Spot Three';
$string['category4'] = 'Category Spot Four';
...
$string['categorytitledesc'] = 'Title to show in this category spot.  You must include a title in order for the Category Tile to appear.';
...
$string['categoryimage_desc'] = 'This provides the option of displaying an image in the category spot';
$string['categorycontent'] = 'Content';
$string['categorycontentdesc'] = 'Content to display in the marketing box. Keep it short and sweet.';
$string['categorybuttontext'] = 'Link Text';
$string['categorybuttontextdesc'] = 'Text to appear on the button.';
$string['categorybuttonurl'] = 'Link URL';
$string['categorybuttonurldesc'] = 'URL the button will point to.';
$string['categoryurltarget'] = 'Link Target';
$string['categoryurltargetdesc'] = 'Choose how the link should be opened';
$string['categoryurltargetself'] = 'Current Page';
$string['categoryurltargetnew'] = 'New Page';
$string['categoryurltargetparent'] = 'Parent Frame';
...
$string['togglecategory'] = 'Category Tile Position';
$string['togglecategory_desc'] = 'Determine where the category tiles will be located on the homepage.';
...
// competency Plugin Integration Enhancements.
$string['integrationinfo'] = 'Plugin Integrations';
$string['integrationinfo_desc'] = 'competency can activate enhanced features and better integrate with certain plugins. The settings below will allow you to use the default plugin behavior or turn on advanced features that the developers of competency have implemented.';
...
$string['collapsibletopics_desc'] = 'If you install the Collapsible Topics Format ( <a href="https://moodle.org/plugins/format_collapsibletopics">format_collapsibletopics</a> ) the competency theme can provide an enhanced course format view and special styling that better integrates with the overall look and feel of competency. Special care and attention has been developed to provide a smoother user experience for users of all ages and skills.';
...
$string['preset_desc'] = 'Pick a preset to broadly change the look of the theme. <a href="https://goo.gl/fMXzSo" target="_new">Instructions for Competency </a>';
$string['favicon'] = 'Favicon';
$string['favicon_desc'] = 'Change the favicon for Competency. Images with a transparent background and 32px height will work best.  Allowed types: PNG, JPG, ICO';
$string['enhancedmydashboard'] = 'Enhanced MyDashboard';
$string['enhancedmydashboard_desc'] = 'Turning this on will enhance the MyDashboard page to include all the competency features such as the Easy Enrollment Form, block sliders, Icon Navigation bar, Custom Homepage Text, Slideshow, and more.';
...
$string['marketingbuttonurldesc'] = 'URL the button will point to.';
$string['marketingurltarget'] = 'Link Target';
$string['bannerlogo'] = 'Banner Image';
$string['bannerlogo_desc'] = 'This Image will be displayed at the top of the page in the header area. It uses bootstrap responsive image scaling.';
$string['marketingurltargetdesc'] = 'Choose how the link should be opened';
$string['marketingurltargetself'] = 'Current Page';
$string['marketingurltargetnew'] = 'New Page';
$string['marketingurltargetparent'] = 'Parent Frame';
